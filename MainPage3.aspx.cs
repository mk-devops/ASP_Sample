...
public partial class MainPage3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                LinqDataSource2 = LinqDataSource1;
    ...
    protected void gridvi_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.Redirect("showprofile2.aspx");
    ...
    protected void gridvi_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        try
        {
            ...
            string s = "javascript:pop_window=window.open('assign_to_admin2.aspx','pop_window','width=950,height=300,top=300,left=80');pop_window.focus()";
    ...
    protected void gridvi0_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            string s = "javascript:pop_window2=window.open('fail_DB.aspx','pop_window2','width=380,height=190,top=300,left=280','titlebar=no', 'toolbar=no','statusbar=no');  pop_window.focus()";
